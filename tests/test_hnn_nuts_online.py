...
from pseudo_marginal.archive_sampling_files.hnn_nuts_online import *
...
def test_get_model(mocker, mock_load_weights):
    ...
    '''
    mocker.patch('pseudo_marginal.archive_sampling_files.hnn_nuts_online.HNN.load_weights', mock_load_weights)
    args = mock_args()
...
def test_build_tree_tf(mocker, mock_integrator):
    ...
    '''
    args = mock_args()
    mocker.patch('pseudo_marginal.archive_sampling_files.hnn_nuts_online.integrator', mock_integrator)
...
def test_sample(mocker, mock_build_tree_tf, mock_get_model):
    ...
    '''
    mocker.patch('pseudo_marginal.archive_sampling_files.hnn_nuts_online.build_tree_tf', mock_build_tree_tf)
    mocker.patch('pseudo_marginal.archive_sampling_files.hnn_nuts_online.get_model', mock_get_model)
    mocker.patch('pseudo_marginal.archive_sampling_files.hnn_nuts_online.np.save')
    mocker.patch('pseudo_marginal.archive_sampling_files.hnn_nuts_online.log_start')
    mocker.patch('pseudo_marginal.archive_sampling_files.hnn_nuts_online.log_stop')
    mocker.patch('pseudo_marginal.archive_sampling_files.hnn_nuts_online.print')
    mocker.patch('pseudo_marginal.archive_sampling_files.hnn_nuts_online.os.makedirs')
...
def test_integration_sample(mocker, mock_get_model_integration):
    ...
    '''
    mocker.patch('pseudo_marginal.archive_sampling_files.hnn_nuts_online.get_model', mock_get_model_integration)
    mocker.patch('pseudo_marginal.archive_sampling_files.hnn_nuts_online.np.save')
    mocker.patch('pseudo_marginal.archive_sampling_files.hnn_nuts_online.log_start')
    mocker.patch('pseudo_marginal.archive_sampling_files.hnn_nuts_online.log_stop')
    mocker.patch('pseudo_marginal.archive_sampling_files.hnn_nuts_online.os.makedirs')
