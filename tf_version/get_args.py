...
def get_args():
    ...
    ############## HMC training hyperparameters ##################################################
    parser.add_argument('--num_hmc_samples', default=35000, type=int, help='number of hmc samples')
    parser.add_argument('--num_burnin_samples', default=5000, type=int, help='number of burn-in samples')
    parser.add_argument('--epsilon', default=0.025, type=float, help='step size for time integration in hmc')
    ...
    ############## PDE hyperparameters ##################################################
    parser.add_argument('--num_pos', default=50, type=int, help="number of sensor points in Elliptic PDE")
